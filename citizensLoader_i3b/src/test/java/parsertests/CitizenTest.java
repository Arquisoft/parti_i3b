...
public class CitizenTest {
	...
	User dummy1 = new User("b", "c", "b@a.com", "10/10/2010", "a", "a",
		"123456789Z", "132456789", 1234);
	User dummy2 = new User("a", "b", "b@a.com", "10/10/2010", "a", "a", "3",
		"132456789", 1234);
	User dummy3 = null;
	User dummy4 = new User("a", "b", "b@a.com", "10/10/2010", "a", "a",
		null, "132456789", 1234);
	User dummy5 = new User("a", "b", "b@a.com", "10/10/2010", "a", "a",
		null, "132456789", 1234);
